...
{
	//testnet difficulty algorithm change point
	if (fTestNet)
		nDiffChangeTarget = 8;
...
#if 0 // it is planned use DigiShield instead
...
#else
    printf("SetBestChain: new best=%s  height=%d  log2_work=%.8g  tx=%lu  date=%s progress=<slod: no checkpoints>\n",
#endif
